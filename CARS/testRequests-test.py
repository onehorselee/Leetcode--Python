...
proxies = {
		 "http": "http://10.248.59.58:5000",
		 "https": "https://10.248.59.58:5000",
		}


def test_get_guideline():
	URL_1 = "http://10.248.59.58:5000/get_guideline"
	for id in ["1"]:
...
def test_jsonget_guideline():
	URL_2 = "http://10.248.59.58:5000/jsonget_guideline"
...
def transfer_log():
	URL_3 = "http://10.248.59.58:5000/transfer_log"
