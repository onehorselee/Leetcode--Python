...
proxies = {
		 ...
		 "https": "https://cars-api.paccar.cloud",
		}


def test_get_guideline():
	URL_1 = "http://cars-api.paccar.cloud/get_guideline"
	for id in ["1"]:
...
def test_jsonget_guideline():
	URL_2 = "http://cars-api.paccar.cloud/jsonget_guideline"
...
def transfer_log():
	URL_3 = "http://cars-api.paccar.cloud/transfer_log"
