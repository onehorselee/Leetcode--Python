...
class cacheSFTables:
    def __init__(self):
        ...
        self.PBTables = ["PB_CUSTOMER_SIZE", "PB_GUIDELINE_LOOKUP"]
        self.KWTables = ["KW_CUSTOMER_SIZE", "KW_ADJUSTER", "KW_BASE_TRUCK_VALUE", "KW_STOCK_CONTROL","KW_DNET", "KW_STOCK_BONUS"]
        self.tableLists = self.PBTables + self.KWTables
